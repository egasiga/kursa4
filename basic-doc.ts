        ...
        sections: [
            {
                ...
                children: [
                    ...
                    new Paragraph({
                        children: [
                            new TextRun("Помимо веб-версии, приложение реализовано в виде настольного программного обеспечения для операционной системы Windows. Настольная версия распространяется в формате исполняемого .exe файла и имеет все те же функциональные возможности, что и веб-версия, но не требует подключения к интернету для обработки изображений, так как все вычисления выполняются локально на компьютере пользователя. Для упаковки веб-приложения в настольное ПО был использован инструмент Electron, который позволяет создавать кроссплатформенные настольные приложения на базе веб-технологий."),
                        ],
                    }),
                    new Paragraph({
                        children: [
                    ...
                    new Paragraph({
                        children: [
                            new TextRun("- Создана версия приложения в формате исполняемого .exe файла для использования на персональных компьютерах под управлением Windows."),
                        ],
                    }),
                    new Paragraph({
                        children: [
